...
Official maps use bundled artwork on cards and the workspace header. Custom maps with a linked
pack show that mod’s CurseForge logo when metadata has a thumbnail.
