...
The workspace **Maintenance** tab can also opt in to **auto-update** when a newer dedicated
build appears: warn players, stop at countdown end, then use the same safe-update path
(skipped while Downloads is paused). See [Maintenance](/docs/maintenance/).
