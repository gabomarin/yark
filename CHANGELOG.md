...
- Workspace **Backups** tab: clearer embedded header with primary **Backup**, denser per-server metric strip (last backup / keep last / destination from existing data), and policy disclosure open by default (collapsible, not kept across kind changes) (#231).
