...
- Docs: expand Maintenance engineering runbook (IPC, cancel/pause, constants, pitfalls) and clarify Cleanup keep-limit vs keep-last-N; cross-link Updates / lifecycle / profile DB (#315).
