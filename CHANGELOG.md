...
- Closing the server console window (or End task / Ctrl+C) while the server is running no longer shows a crash state or Windows crash toast; Runtime notes that the operator closed the window (#524).
