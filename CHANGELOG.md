...
- Workspace **Backups** tab: clearer embedded header with primary **Backup**, shared Destination above kind tabs (default root for world/players/INI), and per-kind policy open by default (collapsible, not kept across kind changes) (#231).
