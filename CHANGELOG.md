...
- Workspace **Backups** tab: clearer embedded header with primary **Backup**, optional per-server metric strip (last backup / keep last / destination from existing data), and policy disclosure collapsed by default (#231).
