...
const YARK_OWNED = [
  ...
  },
  {
    ...
    pattern: /^-WinLiveMaxPlayers(=|$)/i,
    token: "-WinLiveMaxPlayers=",
    notes: "Always composed from profile.maxPlayers. ASA ignores INI MaxPlayers; default 70 if omitted.",
  },
  {
    id: "mods",
    pattern: /^-mods(=|$)/i,
  ...
  const catalog = {
    ...
    ownershipRules: {
      ...
      composerOrder: [
        '"Map"?SessionName=',
        "-port=",
        "-WinLiveMaxPlayers= (from profile.maxPlayers)",
