...
- **Focus ring:** one token, `--app-color-focus-ring`, on every `:focus-visible`. Do not invent per-feature rings and do not reuse `--app-color-cryo` there — that reads as *info*, not focus.
