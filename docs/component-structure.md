...
| --- | --- | --- | --- |
| **Atom** | Tiny presentational unit; little/no feature logic | `src/renderer/src/shared/ui/*` | `AppSurfaceCard`, `EmptyState`, `SearchField`, `ReadonlyPath`, `PathField`, `ServerRuntimeStatusBadge`, `SelectableListRow`, `AccentIconTile` |
