...
| --- | --- | --- | --- |
| **Atom** | Tiny presentational unit; little/no feature logic | `src/renderer/src/shared/ui/*` | `AppSurfaceCard`, `EmptyState`, `SearchField`, `ReadonlyPath`, `PathField`, `ConsoleSurface`, `AppMetricCard`, `ServerRuntimeStatusBadge`, `StatusWord`, `DismissibleHint`, `SelectableListRow`, `YarkDataTable`, `AccentIconTile` |
