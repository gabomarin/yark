...
export const MAP_NAME_COPY = {
  ...
  confirmInferredHint: "YARK read this from CurseForge — confirm with the mod page or map community before you apply.",
  customUsuallyEndsWp:
  ...
  searchMapsCreateHint: "Official ASA maps, or Search Maps… to find a mod map.",
  saveFolderDiffers:
  ...
  verifyOnCurseForge: "Confirm with the CurseForge mod page or the map community before you apply.",
  setUnderCustom:
  ...
  createNeedsSearchMaps: "Mod maps are not listed here yet — use Search Maps… to find the mod.",
  ...
  applyConfirmIntro: "Sets the map name and adds this map mod to Mods (enabled) for this server.",
  applyConfirmNeedsMapName: "Enter the map name before you can use this map.",
  mapPackAlertTitle: "Map mod",
  /** Empty Mod Maps section in the Map popover (#460). */
  modMapsEmptyPopover: "No map mods on Mods yet. Use Search Maps…, or add the mod on the Mods tab first.",
