...
/**
 * App shell composition: owns `useApp*` orchestration, builds router slices,
 * and renders sibling chrome (Spotlight, setup wizard, clone/delete/copy/import).
 */
      ...
      <AppMainRouter
        ...
        lifecycle={{
          ...
          actions: {
            ...
            restartServerWithWarning: (id) => void restartServerWithWarning(id),
            cancelRestartWarning: (id) => void cancelRestartWarning(id),
            openServerMaintenance,
            confirmKillServer,
            setServerEnabled,
            openServerLogs,
