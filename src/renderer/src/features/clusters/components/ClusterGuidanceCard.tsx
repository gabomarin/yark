      ...
      <Accordion.Item value="how">
        ...
        <Accordion.Panel>
          <Text size="sm" c="dimmed">
            ...
            so ARK can move creatures and items between maps. Set both on each server (form or workspace checklist). A
            directory alone is not enough. This page checks that Cluster ID and shared folder match. It does not watch
            live transfers in-game yet.
          </Text>
        </Accordion.Panel>
      </Accordion.Item>
    </Accordion>
