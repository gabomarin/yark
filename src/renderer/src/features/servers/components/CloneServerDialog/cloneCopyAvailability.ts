...
export function isCloneCopyUnavailable(health: InstallationHealthStatus | null | undefined): boolean {
  return health === "missing" || health === "empty" || health === "inaccessible" || health === "unknown";
}

export function cloneCopyCheckboxDescription(health: InstallationHealthStatus | null | undefined): string {
...
export function cloneCopyWarning(health: InstallationHealthStatus | null | undefined): string | null {
