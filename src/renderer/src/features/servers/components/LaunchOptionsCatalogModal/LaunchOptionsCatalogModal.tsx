      ...
      <div className={classes.root} data-density={density}>
        <header className={classes.header}>
          <p className={classes.subtitle}>
            ...
            <Anchor href={asaLaunchOptionsCatalog.source.url} target="_blank" rel="noreferrer" size="sm">
          ...
          <div className={classes.versionCard}>
            ...
            <div className={classes.versionValue}>{asaLaunchOptionsCatalog.version}</div>
          </div>
        </header>
