 ...
 */
globalThis.setTimeout = ((handler: TimerHandler, delay?: number, ...args: unknown[]): ReturnType<typeof setTimeout> => {
...
Object.defineProperty(window, "matchMedia", {
  ...
  value: (query: string) => ({
    ...
    matches: query === "" || /prefers-reduced-motion:\s*reduce/i.test(query),
    media: query,
    onchange: null,
