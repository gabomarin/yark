...
export function createRendererApiMock(overrides: Partial<RendererApi> = {}): RendererApi {
  return {
    ...
    getAsaApiStatus: vi.fn().mockResolvedValue({
      ok: true,
      data: {
        installedOnDisk: false,
        loaderPresent: false,
        loaderPath: null,
        versionDllPresent: false,
        versionDllDisabledPresent: false,
        versionDllPath: null,
        apiCorePresent: false,
        win64Path: "C:/ARK/Win64",
        pluginsPath: "C:/ARK/Win64/ArkApi/Plugins",
        plugins: [],
    ...
    installAsaApi: vi.fn(),
    uninstallAsaApi: vi.fn(),
    setAsaApiPluginEnabled: vi.fn(),
    deleteAsaApiPlugin: vi.fn(),
    addAsaApiPluginZip: vi.fn(),
    openAsaApiWin64: vi.fn(),
    openAsaApiPlugins: vi.fn(),
    clearAsaApiCache: vi.fn().mockResolvedValue({ ok: true, data: undefined }),
    ...
    getAppearance: vi.fn().mockResolvedValue({ ok: true, data: { theme: "dark", layout: "adaptive" } }),
    setAppearance: vi.fn().mockResolvedValue({ ok: true, data: { theme: "dark", layout: "adaptive" } }),
    ...
    setHostedResourcesEnabled: vi.fn(),
    setHostedResourcesPort: vi.fn(),
    createHostedResource: vi.fn(),
    publishHostedResourceContent: vi.fn(),
    getHostedResourceContent: vi.fn().mockResolvedValue({ ok: true, data: "" }),
    publishHostedResourceRevision: vi.fn(),
    renameHostedResource: vi.fn(),
    updateHostedResourceMetadata: vi.fn(),
    ...
    onAsaApiInstallProgress: vi.fn(() => () => undefined),
