...
export const FALLBACK_SPLASH_TEMPLATE = `<!DOCTYPE html><html lang="en" data-yark-splash="1"><head><meta charset="utf-8"/><title>YARK</title><style>html,body{margin:0;height:100%;background:${BRAND_PLATE_BACKGROUND};color:#aabedb;font:600 13px "Segoe UI",sans-serif;display:grid;place-items:center}</style></head><body><p>__YARK_VERSION__</p></body></html>`;
