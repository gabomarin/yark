      ...
      try {
        ...
        if (
          ...
          this.instances.update(targetId, {
            ...
            mapSaveFolder: target.mapSaveFolder ?? null,
            installDir: target.installDir,
            autoStart: target.autoStart,
            useAsaApi: target.useAsaApi === true,
            useAsaApiLoader: target.useAsaApiLoader === true,
    ...
    try {
      if (selection.mods.enabled || selection.extraArgs.enabled || selection.passwords) {
        this.instances.update(targetId, {
          ...
          mapSaveFolder: profileSnapshot.mapSaveFolder ?? null,
          installDir: profileSnapshot.installDir,
          autoStart: profileSnapshot.autoStart,
          useAsaApi: profileSnapshot.useAsaApi === true,
          useAsaApiLoader: profileSnapshot.useAsaApiLoader === true,
          sessionName: profileSnapshot.sessionName,
          maxPlayers: profileSnapshot.maxPlayers,
